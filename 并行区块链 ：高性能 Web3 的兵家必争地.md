...
**并行区块链主要分为单体区块链和模块化区块链两大板块，单体区块链又分为 L1 和 L2 两类**。从项目总数和几个主要赛道的发展可以看出，各并行 EVM L1 公链生态相比以太坊生态仍然存在很大的发展空间。 DeFi 赛道有“高速低费率”的诉求，游戏赛道有“强实时交互”的诉求，二者都对执行速度有一定要求。并行 EVM 必然会给这些项目带来更好的用户体验，推动行业的发展进入到全新的阶段。
